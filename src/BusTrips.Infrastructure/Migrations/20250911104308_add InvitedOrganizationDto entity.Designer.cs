...
namespace BusTrips.Infrastructure.Migrations
{
    ...
    [Migration("20250911104308_add InvitedOrganizationDto entity")]
    partial class addInvitedOrganizationDtoentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusTrips.Domain.Entities.InvitedOrganizationDto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InvitedOrganizationDto");
                });

            modelBuilder.Entity("BusTrips.Domain.Entities.InvitedOrganizationDto+GroupListItemVm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("InvitedOrganizationDtoId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("InvitedOrganizationDtoId");

                    b.ToTable("GroupListItemVm");
                });
            ...
            modelBuilder.Entity("BusTrips.Domain.Entities.OrganizationPermissions", b =>
                {
                    b.Property<Guid>("PId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BusTrips.Domain.Entities.TermsAndConditions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BusTrips.Domain.Entities.Trip", b =>
                {
                    ...
                    b.Property<string>("EstimateLinkUrl")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("GroupId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("InvoiceLinkUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BusTrips.Domain.Entities.InvitedOrganizationDto+GroupListItemVm", b =>
                {
                    b.HasOne("BusTrips.Domain.Entities.InvitedOrganizationDto", null)
                        .WithMany("Groups")
                        .HasForeignKey("InvitedOrganizationDtoId");
                });
