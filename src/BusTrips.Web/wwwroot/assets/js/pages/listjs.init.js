...
xhttp.onload = function () {
  ...
  UserList.remove("id", '<a href="javascript:void(0);" class="fw-medium link-primary">#VZ2101</a>');
}
xhttp.open("GET", "/assets/json/table-User-list.json");
xhttp.send();
            ...
            Array.from(itemValues).forEach(function (x) {
                ...
                if (isdeleteid == itemId) {
                    document.getElementById("delete-record").addEventListener("click", function () {
                        UserList.remove("id", isElem.outerHTML);
            ...
            btn.addEventListener("click", function (e) {
                ...
                Array.from(itemValues).forEach(function (x) {
                    ...
                    if (selectedid == itemId) {
                        ...
                        UserNameField.value = x._values.User_name;
...
function deleteMultiple() {
  ...
  if (typeof ids_array !== 'undefined' && ids_array.length > 0) {
    if (confirm('Are you sure you want to delete this?')) {
        ...
        UserList.remove("id", `<a href="javascript:void(0);" class="fw-medium link-primary">${id}</a>`);
      });
